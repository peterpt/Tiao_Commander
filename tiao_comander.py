...
class CreditsTab(QWidget):
    ...
    def initUI(self):
        ...
        lbl_title = QLabel("TIAO Commander"); lbl_title.setStyleSheet("font-size: 24px; font-weight: bold; color: #00aaff;"); lbl_title.setAlignment(Qt.AlignCenter); layout.addWidget(lbl_title)
        lbl_ver = QLabel("(Version 1.0)"); lbl_ver.setStyleSheet("font-size: 14px; color: #aaaaaa;"); lbl_ver.setAlignment(Qt.AlignCenter); layout.addWidget(lbl_ver); layout.addSpacing(40)
...
class TiaoPro(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("TIAO Universal Commander")
